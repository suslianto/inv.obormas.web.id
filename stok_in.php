            ...
            $resulte=mysqli_query($conn,$sql);
                 ...
                 if(mysqli_num_rows($resulte)>0){
                    ...
                    if($ucart){
                     ...
                     $sql3 = "UPDATE mutasi SET jumlah='$newcart', sisa='$newstok' WHERE keterangan='$nota' AND kegiatan='$kegiatan' ";
                 ...
                 $sql4=mysqli_query($conn,"INSERT INTO mutasi VALUES('$usr','$today','$jam','$kode','$newstok','$jumlah','stok masuk','$nota','','','pending')");
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="row">
           ...
           <button type="button" class="btn btn-danger btn-xs" onclick="window.location.href='component/delete/delete_stok?keg=<?php echo $kegiatan.'&'; ?>&get=<?php echo 'in'.'&'; ?>barang=<?php echo $fill['kode_barang'].'&'; ?>nota=<?php echo autoNumber().'&'; ?>jumlah=<?php echo $fill['jumlah'].'&'; ?>&no=<?php echo $fill['no'].'&'; ?>forward=<?php echo $tabel.'&';?>forwardpage=<?php echo "".$forwardpage.'&'; ?>chmod=<?php echo $chmod; ?>'">Hapus</button>
           <?php } else {}?>
           </td></tr>
           <?php
           $i++;
