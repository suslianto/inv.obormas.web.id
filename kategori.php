                    ...
                    <?php if ($chmod >= 1 || $_SESSION['jabatan'] == 'admin') : ?>
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title" style="vertical-align: middle; margin-right: 10px;"><?php echo $dataapa; ?> <?php echo $totaldata; ?></h3>
                                <a href="add_kategori" class="btn btn-info btn-sm" style="vertical-align: middle;"><i class="fa fa-plus"></i> Tambah</a>
