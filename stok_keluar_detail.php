        ...
        <section class="content">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    $halaman = "stok_keluar_batal.php";
                    $dataapa = "Barang Keluar";
                    $tabeldatabase = "stok_keluar_daftar";
                    $chmod = $chmenu5;
                    $forward = mysqli_real_escape_string($conn, $tabeldatabase);
                    $forwardpage = mysqli_real_escape_string($conn, 'stok_keluar.php');
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="stok_keluar.php"><?php echo $dataapa ?></a></li>
                        <li class="active">Detail Stok Keluar</li>
                    </ol>

                    <?php if ($chmod >= 1 || $_SESSION['jabatan'] == 'admin'): ?>
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Detail Stok Keluar No. Trx: <?php echo htmlspecialchars($nota); ?></h3>
                            <div class="box-tools pull-right">
                                <a href="stok_keluar" class="btn btn-sm btn-default">Simpan</a>
                            </div>
                        </div>
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($chmod >= 4 || $_SESSION['jabatan'] == 'admin') { 
                                                $cancel_url = "component/delete/delete_keluar.php?no=".$fill['no']."&forward=".$forward."&forwardpage=".$forwardpage."&nota=".$fill['nota']."&jumlah=".$fill['jumlah']."&kode=".$fill['kode_barang']."&chmod=".$chmod;
                                            ?>
