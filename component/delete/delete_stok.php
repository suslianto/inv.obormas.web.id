...
if($jumlah >= $terbeliawal){
 ...
 if (mysqli_query($conn, $sqla)) {
  $mutasi=mysqli_query($conn,"delete from mutasi where kodebarang='".$barang."' and keterangan='".$nota."' and kegiatan='".$keg."' ") 
 ...
 ?>
  ...
  <input type="hidden" name="kode" value="<?php echo $nota;?>" />
