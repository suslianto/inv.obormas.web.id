        ...
        <section class="content">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    $halaman = "mutasi";
                    $dataapa = "Mutasi Barang";
                    $tabeldatabase = "mutasi";
                    $chmod = $chmenu8;
                    ...
                    <div class="box" id="tabel1">
                            ...
                            <div class="box-tools pull-right no-print">
                                <form method="post" action="" style="display:inline-block; margin-left: 10px;">
                                    <div class="input-group input-group-sm" style="width: 250px;">
                                        <input type="text" name="search" class="form-control pull-right" placeholder="Cari Barang, User, Kegiatan..." value="<?php echo htmlspecialchars($search); ?>">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            $sql_where = "";
                            if (!empty($search)) {
                                $sql_where = " WHERE barang.nama LIKE '%$search%' OR mutasi.kegiatan LIKE '%$search%' OR mutasi.namauser LIKE '%$search%'";
                            }
                            
                            $sql_count = "SELECT COUNT(*) AS totaldata FROM mutasi INNER JOIN barang ON mutasi.kodebarang = barang.kode" . $sql_where;
                            ...
                            $sql_data = "SELECT mutasi.*, barang.nama FROM mutasi INNER JOIN barang ON mutasi.kodebarang = barang.kode" . $sql_where . " ORDER BY mutasi.no DESC LIMIT $i, $rpp";
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($fill['namauser']); ?></td>
                                        ...
                                        <td>
                                            <?php if($fill['status'] == "berhasil"){ ?>
                                                <span class="label label-success"><?php echo $fill['status'];?></span>
                                            <?php } else { ?>
                                                <span class="label label-danger"><?php echo $fill['status'];?></span>
                                            <?php } ?>
                                        </td>
