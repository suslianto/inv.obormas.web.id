    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
         ...
         if($chmod >= 3 || $_SESSION['jabatan'] == 'admin'){
           ...
           echo "<script>swal('Gagal!', 'Data gagal diupdate!', 'error').then(function() { window.location = '$forwardpage'; });</script>";
           }
         }
           ...
           echo "<script>swal('Gagal!', 'Data gagal disimpan!', 'error').then(function() { window.location = '$forwardpage'; });</script>";
           }
           }
